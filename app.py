...
# --- [4단계: 데이터 편집 및 재고 관리] ---
            ...
            # 3. [필터링] 'QT' 제외 및 품절/검색 필터
            # 상품명에 'QT' 또는 'qt'가 포함된 행은 제외함
            ...
            # 모든 컬럼을 TextColumn으로 설정하여 왼쪽 정렬 강제
