...
if st.session_state.get('analyzed') and st.session_state.p:
    st.divider()
    ...
    with st.form("form_v4_safe"):
        ...
        if st.form_submit_button("💾 입고량 반영 및 저장", use_container_width=True, type="primary"):
            ...
            if edits:
                ...
                st.success("✅ 리오더 현황 및 입고 기록이 성공적으로 저장되었습니다.")
                time.sleep(1)
                st.rerun()
