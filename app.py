        ...
        with st.form("final_form"):
            edited_df = st.data_editor(
                ...
                column_config={
                    ...
                    p['vn']: st.column_config.TextColumn("공급처", width=120, disabled=True),
                    ...
                    "기존리오더": st.column_config.NumberColumn("기존리오더", width=90, disabled=True, format="%d"),
                    "입고차감": st.column_config.NumberColumn("📥 입고(-)", width=90, min_value=0), 
                    "추가발주": st.column_config.NumberColumn("➕ 발주(+)", width=90, min_value=0),
