...
# --- [4단계: 데이터 편집 및 재고 관리] ---
        ...
        # 💡 [화면 고정 핵심] 폼을 사용하여 입력 중 상단 이동 차단
        with st.form("form_step_4"):
            ...
            submit_v4 = st.form_submit_button("💾 4단계 변경사항 저장 (수정 후 반드시 클릭)", use_container_width=True)
