...
if st.session_state.df_raw is not None:
    ...
    if '권장 발주량' in st.session_state.df_raw.columns:
        ...
        if not to_order.empty:
            display_df = to_order[[vendor, item, option, vendor_item_name, '권장 발주량']].rename(columns={vendor: "공급처", item: "상품명", option: "옵션", vendor_item_name: "공급처 상품명", '권장 발주량': "최종 발주량"})
